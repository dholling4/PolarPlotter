...
persons = [
    {"image_url": "https://drive.google.com/uc?export=download&id=1MCxkD8d3-JBgi-xVA_IlzMZ_SJ4AOtbE", "name": "The Digital Athlete: Transforming your run using data-driven wearables & AI", "description": " "},

...
motion_hip = pd.DataFrame(
    {
        "Left Hip": left_hip_list_x[:95],
        "Right Hip": right_hip_list_x[:95]
    }
)
...
df = pd.DataFrame(
  {
      "Joint": ['L Wrist', 'R Wrist', 'L Shoulder', 'R Shoulder', 'L Ankle', 'R Ankle',
                'L Hip', 'R Hip', 'L Knee', 'R Knee'],
      "Confidence Score": [left_wrist_list_conf, right_wrist_list_conf, left_shoulder_list_conf, right_shoulder_list_conf, left_ankle_list_conf, right_ankle_list_conf, left_hip_list_conf, right_hip_list_conf, left_knee_list_conf, right_knee_list_conf],
  }
)  
